...
try{
    ...
    if(allCartData){
        return res.json({msg:'Product Inserted Successfully!',data:allCartData});
    }else{
...
try{
    ...
    if(singleCartData){
        return res.json({msg:'Product Found Successfully!',data:singleCartData});
    }else{
...
try{
    ...
    const CartSave =await Cart.save(postInfo);
    if(CartSave){
